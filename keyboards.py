...
def get_main_menu(is_admin: bool = False, is_premium: bool = False):
    ...
    buttons = [
        [
            InlineKeyboardButton(text="📚 O'rganish", callback_data="learn"),
            InlineKeyboardButton(text="🧠 Testlar", callback_data="quizzes")
        ],
        [
            InlineKeyboardButton(text="🤖 AI suhbat & Grammar (Premium)", callback_data="conversation"),
            InlineKeyboardButton(text="🏆 Reyting", callback_data="show_rating")
        ],
        [
            InlineKeyboardButton(text="📖 Grammar AI (Premium)", callback_data="grammar_ai"),
            InlineKeyboardButton(text="💎 Premium", callback_data="premium")
        ],
        [
            InlineKeyboardButton(text="📊 Mening jarayonim", callback_data="my_progress"),
            InlineKeyboardButton(text="📈 Test statistikasi", callback_data="quiz_stats")
        ]
    ]
